...
export const AutoList = () => {
  ...
  const obtenerImagen = (marca, modelo) => {
    const imagenes = {
      'hyundai_elantra': '/images/Hyundai.jpg',
      'toyota_corolla': '/images/Toyota_Corolla.jpg',
      'honda_civic': '/images/honda_civic.jpg',
      'mazda_mazda3': '/images/Mazda3.png',
      'nissan_navara': '/images/nissan_navara.jpg',
      'kia_rio': '/images/Kia_Rio.jpg',
      'hyundai_tucson': '/images/hyundai_tucson.jpg',
    };
    const clave = `${marca.toLowerCase()}_${modelo.toLowerCase()}`;
    return imagenes[clave] || '/images/default.jpg';
  };
