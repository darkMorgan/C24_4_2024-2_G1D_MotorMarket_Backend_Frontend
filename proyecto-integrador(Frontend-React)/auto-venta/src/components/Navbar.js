    ...
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
      <div className="container">
        <Link className="navbar-brand" to="/">
          <img src="/images/motormarketlogo1.png" alt="Icono de MotorMarket" style={{ width: '60px', marginRight: '10px' }} />
          MotorMarket
        </Link>
        <button
          ...
          <ul className="navbar-nav">
            ...
            {username && (
              <>
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="/autos_usados">Autos Seminuevos </Link>
                </li>
                <li className="nav-item">
